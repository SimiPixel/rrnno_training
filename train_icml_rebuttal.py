...
def main(
    ...
    if delete_subsys is not None:
        sys_noimu = sys_noimu.delete_system(delete_subsys)

    ringnet = _make_ring(sys_noimu.link_parents, warmstart)
    ...
    axes = {
        1: axes_S_06_07,
        2: axes_S_06_07,
        10: {"left": ("seg1", "seg4"), "right": ("seg2", "seg3")},
    }
